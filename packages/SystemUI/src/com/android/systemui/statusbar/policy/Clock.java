...
public class Clock extends TextView implements
    ...
    public static final String STATUS_BAR_CLOCK_AUTO_HIDE_TIMER =
    ...
    private boolean mClockAutoHideTimer;
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
            ...
            Dependency.get(TunerService.class).addTunable(this,
                    ...
                    STATUS_BAR_CLOCK_AUTO_HIDE_TIMER,
    ...
    private void updateClockVisibility() {
        ...
        if (mClockAutoHideTimer && visible && mScreenOn) {
    ...
    public void onTuningChanged(String key, String newValue) {
        switch (key) {
            ...
            case STATUS_BAR_CLOCK_DATE_FORMAT:
                ...
                break;
            case STATUS_BAR_CLOCK_AUTO_HIDE_TIMER:
                mClockAutoHideTimer =
                    mIsStatusBar &&
                        TunerService.parseIntegerSwitch(newValue, false);
                break;
